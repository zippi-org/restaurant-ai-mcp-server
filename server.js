...
// SETUP ENDPOINT - Run once to populate knowledge base
app.post('/setup/populate-knowledge-base', async (req, res) => {
  try {
    ...
    // Insert restaurant technology companies
    await client.query(`
    ...
    res.json({
      status: 'success',
      message: 'Knowledge base populated with restaurant industry intelligence',
      data_added: {
        companies: 3,
        technologies: 3, 
        trends: 4,
